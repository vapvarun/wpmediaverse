...
covers: [private-stays-local, privacy-gate, signed-url, no-public-cloud-leak]
prerequisites:
...
5. Anonymous gets 403 and never sees it.
6. No absolute public cloud URL is ever emitted for the private item.
