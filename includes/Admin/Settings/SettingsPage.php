...
class SettingsPage {
	...
	private function get_registered_sections(): array {
		$sections = array(
			...
			'ai'          => array(
				'group'        => 'safety',
				'label'        => __( 'AI', 'wpmediaverse' ),
				'icon'         => 'sparkles',
				'description'  => __( 'AI providers, auto-analysis, and tagging.', 'wpmediaverse' ),
				'option_group' => self::OPTION_GROUP . '_ai',
				'page_slug'    => self::PAGE_SLUG . '-ai',
				'section_ids'  => array( 'mvs_ai' ),
				'is_pro'       => false,
				'priority'     => 50,
			),
			'moderation'  => array(
	...
	private function group_sections( array $sections ): array {
		$group_labels = array(
			...
			'safety'   => __( 'Safety', 'wpmediaverse' ),
			'access'   => __( 'Access & Integrations', 'wpmediaverse' ),
			// Legacy keys kept so older filters / Pro builds still resolve.
			'social'   => __( 'General', 'wpmediaverse' ),
			'storage'  => __( 'Media', 'wpmediaverse' ),
			'ai'       => __( 'Safety', 'wpmediaverse' ),
			'advanced' => __( 'Access & Integrations', 'wpmediaverse' ),
