...
<div class="mvs-chat-composer">
	...
	<div class="mvs-chat-composer__row" data-wp-bind--hidden="state.isRecordingVoice">
		<div class="mvs-chat-composer__actions">
			<!-- Attachment button -->
			<button class="mvs-chat-composer__btn" data-wp-on--click="actions.openAttachmentPicker" type="button" aria-label="Attach file">
			...
			<!-- Voice record button -->
			<button class="mvs-chat-composer__btn" data-wp-on--click="actions.startVoiceRecording" type="button" aria-label="Record voice message">
	...
	<div class="mvs-chat-composer__row" data-wp-bind--hidden="!state.isRecordingVoice">
		<div class="mvs-chat-composer__voice-recording">
			...
			<button class="mvs-chat-composer__voice-cancel" data-wp-on--click="actions.cancelVoiceRecording" type="button">Cancel</button>
		</div>
		<button
			class="mvs-chat-composer__send"
