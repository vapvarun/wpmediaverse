...
( function() {
	...
	// Intercept clicks on media images in the activity stream.
	// - Images linking to raw file URLs → redirect to media permalink
	// - Images linking to /media/{slug}/ → let browser navigate (normal link)
	document.addEventListener( 'click', function( e ) {
		...
		// Raw file URL (old posts) — redirect to media permalink if available.
		...
		// Links to /media/{slug}/ — normal navigation (single page has full UX).
	} );
} )();
